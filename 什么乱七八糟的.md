...
- /app/controllers/
    ...
    - interface/
        - czwy/
            - campaign_service.js：campaign_service的接口
            - gas_service.js：gae_service的接口
            - violation_service.js：violation_service的接口
            - weixin_service.js：weixin_service的接口
            - index.js：根据服务分层？
            - proxy.js：获取服务API？
            - static_page.js：根据funcid配置静态页面(至少需要title、template、useReact)
        - fanli/
            - 
```
